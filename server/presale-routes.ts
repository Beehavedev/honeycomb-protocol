  ...
  try {
    ...
    const [privatePhase] = await db
      ...
      .values({
        ...
        description:
          "Exclusive early access for whitelisted community members. 50% discount from listing price with vesting.",
      })
      .returning();
    ...
    const [publicPhase] = await db
      ...
      .values({
        ...
        description:
          "Open to all participants. 20% discount from listing price with shorter vesting.",
      })
      .returning();
