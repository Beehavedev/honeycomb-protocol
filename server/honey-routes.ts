...
const HONEY_TOKEN_INFO = {
  ...
  chains: [56, 97],
  distribution: {
    fairLaunch: { percentage: 40, amount: "400000000", label: "FourMeme Fair Launch", tgeUnlock: 100, cliff: "None", vesting: "Immediate via bonding curve" },
    communityStaking: { percentage: 20, amount: "200000000", label: "Community & Staking Rewards", tgeUnlock: 0, cliff: "None", vesting: "Released over 4 years via staking/earning" },
    liquidity: { percentage: 20, amount: "200000000", label: "Liquidity Pool", tgeUnlock: 100, cliff: "None", vesting: "Locked 2 years, then linear unlock" },
    ecosystem: { percentage: 10, amount: "100000000", label: "Ecosystem & Development", tgeUnlock: 0, cliff: "1 month", vesting: "Linear over 24 months after cliff" },
    marketing: { percentage: 5, amount: "50000000", label: "Marketing", tgeUnlock: 0, cliff: "1 month", vesting: "Linear over 12 months after cliff" },
    treasury: { percentage: 5, amount: "50000000", label: "Treasury (DAO)", tgeUnlock: 0, cliff: "1 month", vesting: "Linear over 24 months after cliff, managed by arms-length entity" },
  },
  feeSplit: {
    platformRevenue: { percentage: 60, label: "Platform Revenue", description: "Direct revenue to the Honeycomb treasury for operations, growth, and team" },
    buybackBurn: { percentage: 25, label: "Buyback & Burn", description: "Used to buy HONEY on the open market and permanently burn it, reducing supply" },
    stakingRewards: { percentage: 15, label: "Staking Rewards", description: "Distributed proportionally to HONEY stakers based on their tier and lock duration" },
  },
  feeSchedule: [
    { feature: "Prediction Duels", bnbFee: "10%", honeyFee: "5%", description: "Fee on duel winnings" },
    { feature: "Token Launchpad", bnbFee: "1%", honeyFee: "0.5%", description: "Fee on bonding curve trades" },
    { feature: "NFA Marketplace", bnbFee: "1%", honeyFee: "0%", description: "Fee on NFA sales" },
    { feature: "AI Agent Marketplace", bnbFee: "10%", honeyFee: "5%", description: "Commission on paid interactions" },
    { feature: "Post Bonds", bnbFee: "0.001 BNB", honeyFee: "50% discount", description: "Anti-spam deposit" },
    { feature: "Bounty Claims", bnbFee: "5%", honeyFee: "2.5%", description: "Fee on bounty payouts" },
  ],
  useCases: [
    "Prediction Duels - 50% reduced fees (5% vs 10% BNB)",
    "Token Launchpad - 50% reduced trade fees, priority access for stakers",
    "Bounty System - Post/claim bounties in HONEY with reduced fees",
    "AI Agent Marketplace - 50% reduced commission fees",
    "NFA Trading - Fee waiver for HONEY-staked users",
    "Staking - Tier benefits with fee discounts up to 50% (Drone/Worker/Guardian/Queen)",
    "Governance - Vote on platform parameters (Guardian/Queen tiers)",
    "Points Conversion - Convert earned points to HONEY at 100:1 ratio",
  ],
};
