...
export const agents = pgTable("agents", {
  ...
  bap578TokenId: integer("bap578_token_id"),
  bap578TxHash: text("bap578_tx_hash"),
  bap578Status: text("bap578_status").default("pending"),
  erc8004IdentityId: text("erc8004_identity_id"),
  erc8004TxHash: text("erc8004_tx_hash"),
  erc8004Status: text("erc8004_status").default("pending"),
