...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    // Landing Page
    'landing.enterArena': 'Enter the Arena',
    ...
    'landing.heroTitle': 'Trade. Battle. Win BNB.',
    'landing.heroSubtitle': '1v1 trading duels on real crypto charts.',
    'landing.heroHighlight': '$1M fake money. Real BNB prizes.',
    'landing.heroTag': 'On-chain escrow on BNB Chain',
    'landing.statPlayers': 'Players',
    'landing.statDuels': 'Duels Played',
    'landing.statVolume': 'Prize Pool Volume',
    'landing.howItWorks': 'How it works',
    'landing.step1Title': 'Connect Wallet',
    'landing.step1Desc': 'Link your BNB Chain wallet and create your player profile in seconds',
    'landing.step2Title': 'Pick a Duel',
    'landing.step2Desc': 'Choose your crypto pair, stake BNB, and challenge an opponent or practice vs bots',
    'landing.step3Title': 'Trade & Win',
    'landing.step3Desc': 'Go long or short with $1M fake cash on real charts. Highest portfolio wins the pot',
    'landing.featureCharts': 'Real Charts',
    'landing.featureChartsDesc': 'Live candlestick data from top exchanges',
    'landing.featureEscrow': 'On-Chain Escrow',
    'landing.featureEscrowDesc': 'BNB locked in smart contract, trustless payouts',
    'landing.featureLeverage': 'Up to 50x Leverage',
    'landing.featureLeverageDesc': 'Go big on your best calls with leveraged positions',
    'landing.featureBots': 'Practice vs Bots',
    'landing.featureBotsDesc': 'Sharpen your skills risk-free against AI opponents',
    'landing.arenaFeatures': 'Arena Features',
    'landing.pvpDuels': 'PvP Duels',
    'landing.pvpDuelsDesc': '1v1 battles with BNB on the line',
    'landing.predictDuels': 'Predict Duels',
    'landing.predictDuelsDesc': 'Call the next price move to win',
    'landing.leaderboards': 'Leaderboards',
    'landing.leaderboardsDesc': 'Climb the ranks and prove your skill',
    'landing.referralTitle': 'Invite Friends, Earn Rewards',
    'landing.referralDesc': 'Bring players to the Arena and earn bonus points',
    'landing.proveSkill': 'Prove Your Skill On-Chain',
  ...
  zh: {
    ...
    // Landing Page
    'landing.enterArena': '进入竞技场',
    'landing.connectWallet': '连接钱包',
    'landing.earlyAdopter': '早期采用者计划',
    'landing.limitedTime': '限时',
    'landing.spotsLeft': '个名额剩余',
    'landing.claimed': '已领取',
    'landing.heroTitle': '交易. 对战. 赢BNB.',
    'landing.heroSubtitle': '真实加密图表上的1v1交易对决.',
    'landing.heroHighlight': '100万虚拟资金. 真实BNB奖励.',
    'landing.heroTag': 'BNB链上链托管',
    'landing.statPlayers': '玩家',
    'landing.statDuels': '已完成对决',
    'landing.statVolume': '奖池总量',
    'landing.howItWorks': '如何参与',
    'landing.step1Title': '连接钱包',
    'landing.step1Desc': '连接BNB链钱包，几秒内创建玩家档案',
    'landing.step2Title': '选择对决',
    'landing.step2Desc': '选择交易对，质押BNB，挑战对手或与机器人练习',
    'landing.step3Title': '交易并获胜',
    'landing.step3Desc': '用100万虚拟资金在真实图表上做多或做空，最高资产组合赢得奖池',
    'landing.featureCharts': '实时图表',
    'landing.featureChartsDesc': '来自顶级交易所的实时K线数据',
    'landing.featureEscrow': '链上托管',
    'landing.featureEscrowDesc': 'BNB锁定在智能合约中，无需信任的支付',
    'landing.featureLeverage': '最高50倍杠杆',
    'landing.featureLeverageDesc': '用杠杆放大你的最佳判断',
    'landing.featureBots': '与机器人练习',
    'landing.featureBotsDesc': '与AI对手零风险磨练技巧',
    'landing.arenaFeatures': '竞技场功能',
    'landing.pvpDuels': 'PvP对决',
    'landing.pvpDuelsDesc': '1v1对战，BNB为赌注',
    'landing.predictDuels': '预测对决',
    'landing.predictDuelsDesc': '预测下一个价格走势来获胜',
    'landing.leaderboards': '排行榜',
    'landing.leaderboardsDesc': '攀登排名，证明你的实力',
    'landing.referralTitle': '邀请好友，获取奖励',
    'landing.referralDesc': '带玩家进入竞技场赚取奖励积分',
    'landing.proveSkill': '在链上证明你的实力',
