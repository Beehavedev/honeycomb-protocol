...
class GameScene extends Phaser.Scene {
  ...
  private spawnObs() {
    ...
    o.setImmovable(true).setDepth(6).setScale(0.25).setAlpha(0.8);
    ...
    else if (t === 5) { o.setSize(220, 20); o.setData("targetX", CX); o.setData("laneOffset", 0); }
    else if (t === 6) { o.setSize(54, 54); }
  ...
  private spawnCoin() {
    ...
    c.setDepth(5).setSize(28, 28).setScale(0.25).setAlpha(0.8);
  ...
  private spawnPU() {
    ...
    p.setDepth(5).setSize(36, 36).setScale(0.25).setAlpha(0.8);
  ...
  update(_t: number, delta: number) {
    ...
    const perspMove = (sprite: Phaser.Physics.Arcade.Sprite) => {
      ...
      const sc = 0.25 + perspP * 0.75;
      sprite.setScale(sc);

      sprite.setAlpha(Math.min(1, 0.8 + p * 0.2));
